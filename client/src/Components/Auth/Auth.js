...
import {Avatar, Box, Button, FormControlLabel, FormLabel, Grid, Container, Radio, RadioGroup, TextField, Typography} from '@mui/material';
    ...
    <>
      ...
      <Container component="main" maxWidth="xs">
        <Box
          ...
          <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 3 }} xs={12}>
            <Grid container spacing={2}>
              ...
              <Grid item xs={12}>
                <Input name="password" value={userObject.password} label="Password" handleChange={handleChange} type={showPassword ? 'text' : 'password'} handleShowPassword={handleShowPassword} error={passwordError.error} helperText={passwordError.message} />
              </Grid>
              
              {Signup.state && <Grid item xs={12} display="flex" justifyContent="space-between">
                <FormLabel component="legend">Role</FormLabel>
                <RadioGroup row name="role" value={userObject.role} onChange={handleChange} sx={{flexWrap:"nowrap"}}>
